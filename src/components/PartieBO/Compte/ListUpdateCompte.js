...
import TableCompte from "./TableCompte";
import AddCompte from "./AddCompte";
import UpdateCompte from "./UpdateCompte";

class ListUpdateCompte extends React.Component {
        ...
        <div class="col-sm-4">
            <div class="page-header float-left">
                <div class="page-title">
                    <h1>Modifier ces champs</h1>
                </div>
            </div>
        </div>

        <UpdateCompte idCompte={this.props.match.params.idCompte} history={this.props.history} />
    </div>
...
export default ListUpdateCompte;
