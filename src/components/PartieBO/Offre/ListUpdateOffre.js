...
class ListUpdateOffre extends React.Component {
...
<div id="right-panel" class="right-panel">
    ...
    <div class="breadcrumbs">
        ...
        <UpdateOffre id_Offre={this.props.match.params.id_Offre} history={this.props.history} />
    </div>
  ...
  export default ListUpdateOffre;
