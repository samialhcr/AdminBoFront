...
import Updateabonne from "./Updateabonne";


class ListUpdateabonne extends React.Component {
...
<div id="right-panel" class="right-panel">
    ...
    <div class="breadcrumbs">
        ...
        <Updateabonne id={this.props.match.params.id} history={this.props.history} />
    </div>
  ...
  export default ListUpdateabonne;
